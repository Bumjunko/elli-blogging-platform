    ...
    <main className="min-h-screen bg-[#f5f7fa] text-slate-950">
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-4 px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <Link href="/admin" className="text-sm font-semibold text-[#174a7c]">
              ...
              <form action={reviewPostAction} className="mt-4 space-y-4">
                ...
                {canReview ? (
                  <div className="grid gap-2">
                    <button
                      ...
                      name="intent"
                      value="approve"
                      className="h-10 rounded-md bg-[#174a7c] px-4 text-sm font-semibold text-white transition hover:bg-[#10385f]"
                    >
                      Approve
                    </button>
                    <button
                ...
                {canPublish ? (
                  <button
                    ...
                    name="intent"
                    value="publish"
                    className="h-10 w-full rounded-md bg-emerald-700 px-4 text-sm font-semibold text-white transition hover:bg-emerald-800"
                  >
                    Publish
                  </button>
                ) : null}
